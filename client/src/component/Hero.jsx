  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="bg-[rgb(241,245,241)] px-1 gap-8 py-1 w-full mx-auto max-w-3xl rounded-full justify-between  flex items-center"
      >
        <input
          type="text"
          placeholder="Search..."
          className="bg-[rgb(241,245,241)] rounded-full focus:outline-none border-none py-2 px-3 w-full "
          value={searchTerm}
