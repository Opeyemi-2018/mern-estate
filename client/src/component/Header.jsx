...
export default function Header({ setShowNav, showNav }) {
  ...
  return (
    <header className='bg-white shadow-lg w-full  z-20'>
      <div className='flex justify-between items-center max-w-6xl mx-auto p-3'>
        <Link to='/'>
          <h1 className='font-bold text-sm sm:text-xl flex flex-wrap gap-1 items-center'>
            ...
            <FaHouseChimney className='text-[#1E2128]' />
          </h1>
        </Link>
        ...
        <ul className='flex items-center gap-4'>
          ...
          {currentUser ? (
            ...
            <Link to={'/sign-in'} className='text-white bg-[#1E2128] px-3 py-1 rounded-md'>
              Sign in
            </Link>
          )}
