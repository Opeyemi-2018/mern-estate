...
const SavedListing = () => {
  ...
  return (
    <div className="px-3">
      ...
      />
      <h1 className="text-2xl font-semibold my-5">Saved Items</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
        {favorites.length > 0 ? (
            ...
            return (
              <div key={_id} className="flex flex-col gap-1 relative group">
                <div className="relative">
                  <button
                    onClick={() => removeFavorite(favorite.listing._id)}
                ...
                <Link
                  to={`/listing/${favorite.listing._id}`}
          ...
          <p className="text-2xl font-semibold mt-20">No saved items yet</p>
        )}
      </div>
    </div>
  );
