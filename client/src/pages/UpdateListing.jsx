    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap gap-6'>
                    <div className='flex items-center gap-2'>
                        <input onChange={handleChange} checked={formData.bedrooms} type="number" id='bedroom' min={'1'} max={'10'} required className='p-3 border border-gray-300 rounded-lg' />
                        <p>Beds</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <input onChange={handleChange} checked={formData.bathrooms} type="number" id='bathrooms' min={'1'} max={'10'} required className='p-3 border border-gray-300 rounded-lg' />
                        <p>baths</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <input onChange={handleChange} checked={formData.regularPrice} type="number" id='regularPrice' min={'50'} max={'1000000'} required className='p-3 border border-gray-300 rounded-lg' />
                    ...
                    {formData.offer && (
                        <div className='flex items-center gap-2'>
                        <input onChange={handleChange} checked={formData.discountPrice} type="number" id='discountPrice' min={'0'} max={'1000000'} required className='p-3 border border-gray-300 rounded-lg' />
                        <div className='flex flex-col items-center'>
                             <p>Discount price</p>
                             <span className='text-sm'>($ / month)</span>
                         </div>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                <p className='font-semibold'>Images: <span className='font-normal text-gray-600 mt-2'>The first image will be the cover (max-6)</span> </p>
