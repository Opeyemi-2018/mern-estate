...
const Footer = () => {
  return (
    <div className="bg-[#1e2128] sm:px-28 px-3 py-10">
      <div className="flex flex-wrap items-center gap-4 justify-between">
        ...
        <div>
          <Link
            to={"/search"}
            className="w-full bg-white  px-3 py-2 rounded-md text-[#1E2128]"
          >
            Get Started
          </Link>
        </div>
      ...
      <div className="flex items-center sm:justify-center justify-start sm:gap-10 gap-5 mt-4">
        ...
        <button className="rounded-full bg-white text-[#001030] p-1">
          <FaXTwitter />
        </button>
        <button className="rounded-full bg-white text-[#001030] p-1">
          <FiFacebook />
