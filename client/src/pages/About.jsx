...
export default function About() {
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto  min-h-screen'>
      <h1 className='text-3xl font-bold mb-4  text-slate-800'>About Opeyemi Estate</h1>
      ...
      <div>
        <h1 className='text-[#dfad39] text-3xl text-center my-6 font-bold'>What we offer</h1>
        <div className='flex items-center md:flex-row flex-col justify-center gap-4'>
          <div className='bg-white p-8 hover:bg-[#1E2128] text-[#1E2128] hover:text-white transition-all duration-300 shadow-lg rounded-lg'>
